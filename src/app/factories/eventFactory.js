hensApp.factory('eventsFactory', [
    '$http', '$rootScope', function ($http, $rootScope) {
        ...
        return {
            ...
            irlHens: {
                getForm() {
                    return declareRoute('get', '/irl-hens/formulaire');
                },
                postFormulaire(formData) {
                    return declareRoute('post', '/irl-hens/formulaire', formData);
                },
                editFormulaire(formData, form_id) {
                    formData.id = form_id;
                    return declareRoute('put', '/irl-hens/formulaire', formData);
                }
            }
        }
    }
